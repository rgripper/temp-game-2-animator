...
//       keypointMap.right_shoulder.x +
//       keypointMap.left_hip.x +
//       keypointMap.right_hip.x) /
//     4;
//   const midY =
//     (keypointMap.left_shoulder.y +
//       keypointMap.right_shoulder.y +
//       keypointMap.left_hip.y +
//       keypointMap.right_hip.y) /
//     4;
...
//     keypointMap.left_shoulder.x < keypointMap.right_shoulder.x ? 1 : -1;
...
//   const lowerShiftX =
//     (torsoParts.left_hip.x -
//       keypointMap.left_hip.x +
//       (torsoParts.right_hip.x - keypointMap.right_hip.x)) /
//     2;
//   const lowerShiftY =
//     (torsoParts.left_hip.y -
//       keypointMap.left_hip.y +
//       (torsoParts.right_hip.y - keypointMap.right_hip.y)) /
//     2;
